...
const NotFound = () => {
  return (
    <>
      ...
      <section className="px-3 md:px-0 min-h-screen pt-[106px] bg-[url('/images/not_found_page.png')] bg-cover bg-no-repeat bg-center h-screen">
        <div className="flex flex-col gap-y-10 mx-auto w-fit text-center">
          <h1 className="text-not_found">Oops!</h1>
          <p className="text-[28px] md:text-[36px] text-beige">404 - Таку сторінку не знайдено</p>
          <p className="w-[336px] md:w-[420px] text-14 text-beige mx-auto">
